...
def get_client_registration(client_id):
    print('\n\n client registrar ....\n\n')
    raise HTTPException(status_code=404, detail="client ID not registered!")
...
#  */
def get_client_account_id_for_credentials(username, password):
    raise HTTPException(status_code=404, detail="client credentials not registered!")
